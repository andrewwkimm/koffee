...
def test_returns_duration(mocker: MockerFixture) -> None:
...
def test_empty_stdout_returns_zero(mocker: MockerFixture) -> None:
...
def test_missing_ffprobe_raises(mocker: MockerFixture) -> None:
...
def test_timeout_raises(mocker: MockerFixture) -> None:
